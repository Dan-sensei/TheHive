...
bool Omicron::Initialize(){
    ...
    hud->initHUD(
        WINDOW_WIDTH,
        WINDOW_HEIGHT,
        gestorRecursos->getConstantTexture("assets/HUD/NUEVO/plantilla.png",4),
...
void Omicron::setLightsZone(uint8_t ZONE, bool Active){
    LIGHTS_LAYER->setActive(ZONE, Active);
}
