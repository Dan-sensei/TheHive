...
void NatureGenerator::init(const uint8_t &map_zone, glm::vec3 &Pos){
    ...
    ZMaterial* Blue = Manager->getMaterial("Blue");

    fabrik->createNatureMesh(Path,Pos,glm::vec3(),Blue,0);
