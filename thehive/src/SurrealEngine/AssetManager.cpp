...
AssetManager::AssetManager(){
    ShaderMap["Nature"].loadFiles("assets/Shaders/VertexShader_NATURE.glsl", "assets/Shaders/GeometryShader_NATURE.glsl", "assets/Shaders/FragmentShader_NATURE.glsl");
    ...
    MAT2->addTexture("DiffuseMap",      "assets/Textures/prueba1.png",       		GN::RGBA, GN::REPEAT_TEXTURE | GN::GEN_MIPMAPS);
